    ...
    mcp_client = MultiServerMCPClient(
        {
            ...
            # "duckduckgo": {
            #     "command": "npx",
            #     "args": ["-y", "duckduckgo-mcp-server"],  # или @nickclyde/duckduckgo-mcp-server
            #     "transport": "stdio",
            # },
            # "playwright": {  # Playwright MCP для скрапинга (навигация по сайтам и заполнения форм)
            #     "command": "npx",
            #     "args": ["@playwright/mcp"],  # или другой Playwright MCP
            #     "transport": "stdio",
            # },
            # "firecrawl": {  # 🔥 Firecrawl для скрапинга
            #     "transport": "streamable_http",
            #     "url": "https://api.firecrawl.dev/mcp",  # Официальный endpoint
            # },
