...
class Config:
    ...
    SUMMARIZATION_TRIGGER_TOKENS: int = 6000  # Начинать суммаризацию при N токенах
    SUMMARIZATION_KEEP_MESSAGES: int = 10  # Держать последние N сообщений после суммаризации